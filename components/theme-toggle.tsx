...
export function ThemeToggle() {
  ...
  return (
    <Button
      ...
      className="p-3 w-12 h-12 bg-white/50 dark:bg-zinc-800/10 backdrop-blur-md border border-white dark:border-zinc-800 rounded-2xl shadow-lg transition-all hover:scale-110 active:scale-95"
    >
